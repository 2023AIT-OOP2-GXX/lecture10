...
| -------------- | ----------- | -------------------------------------- |
| 榊原　竜一     | K22059      | Ryuichi8901 (ryuichi12252003@gmail.com) |
...
　・古いバージョンから新しいバージョンのファイルまで一元的に管理が可能である。<br>
　・Gitが各ファイルの変更履歴を管理しているので仮に誤って上書きしてしまっても、すぐに任意のバージョンに戻すことができる。<br>
　・チームでファイルや変更履歴を共有できる<br>
　・豊富な機能を使いチームでの共同開発を効率化できる<br>
...
mainブランチから、作業ブランチを切る (作業ブランチの作成)<br>
作業ブランチでファイル(コード)の変更を行う<br>
変更をコミットしてプッシュする（各コミットにわかりやすいメッセージを付ける）<br>
プルリクエストを作成する<br>
マージする<br>

解決できるチーム開発での問題・・・コードの議論の利便性<br>
ソースコードの変更部分を明確に表示できるため、ソースコードの意図などをコメントとして伝えることができる。誰がどんな作業をしたかすぐわかる。何よりPull Request上でコメントをやりとりして議論できるためソースコードの品質を高くできる。